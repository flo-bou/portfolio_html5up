...
* Toutes les informations sont perdues pour l'utilisateur !
*/
echo '<meta http-equiv="refresh" content="6;URL='.$URL_FORM_DEV.'">';
echo '<style>';
echo 'body { background: url("'.$FOLDER_IMAGES.'bg.jpg") no-repeat center center fixed; background-size: cover; color:#FFFFFF }';
echo 'h1 { color:#FFF000 }';
echo '</style>';
echo '</head>';
/* HISTORY BACK : 
...
echo '<img src="'.$FOLDER_IMAGES.'Oops.svg" width="400" height="400" alt="OOPS!" title="OOPS!" />';  // Style avec un rgos message d'erreur
