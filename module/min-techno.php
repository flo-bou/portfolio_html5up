<?php
echo '<header>';
echo '<h2 class="major">'.$Mod_Techno_title.'</h2>';
echo '</header>';
include $Mod_Techno_txt; // On include le fichier depuis une variable définie dans SetVar ?>
    <section>
    <div class="row">
     ...
     <!-- Pour les modals
    <div id="html_5" class="modalDialog">
        <div>
            <a href="#close" title="Fermer" class="close">X</a>
            <h2>HTML 5</h2>
            <p>HTML est le langage de balisage conçu pour représenter les pages web.</p>
        </div>
    </div>
    <div id="css_3" class="modalDialog">
        <div>
            <a href="#close" title="Fermer" class="close">X</a>
            <h2>CSS 3</h2>
            <p>CSS est un langage informatique qui décrit la présentation des documents HTML.</p>
        </div>
    </div>
    <div id="java_s" class="modalDialog">
        <div>
            <a href="#close" title="Fermer" class="close">X</a>
            <h2>JavaScript</h2>
            <p>Js est un langage de scripts très utile pour créer des pages web interactives.</p>
        </div>
    </div>
    <div id="php" class="modalDialog">
        <div>
            <a href="#close" title="Fermer" class="close">X</a>
            <h2>PHP</h2>
            <p>PHP est un langage utilisé pour produire des pages Web dynamiques.</p>
        </div>
    </div>
    <div id="git" class="modalDialog">
        <div>
            <a href="#close" title="Fermer" class="close">X</a>
            <h2>Git</h2>
